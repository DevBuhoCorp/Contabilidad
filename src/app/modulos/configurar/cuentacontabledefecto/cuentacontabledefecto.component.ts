...
import { CuentaDefectoService } from './cuentacontabledefecto.service'; 


@Component({
  selector: 'app-cuentacontabledefecto',
  templateUrl: './cuentacontabledefecto.component.html',
  styles: []
})
export class CuentacontabledefectoComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private crudService: CuentaDefectoService,
  ) { }
