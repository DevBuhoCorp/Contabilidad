...
export const ModulosRoutes: Routes = [
    ...
    {
        path: 'configurar/diarioscontables', component: DiarioscontablesComponent, data: { title: 'Diarios Contables', breadcrumb: 'CONFIGURAR DIARIOS CONTABLES' }
    },
    {
    ...
    {
        path: 'configurar/grupospersonalizados', component: GrupospersonalizadosComponent, data: { title: 'Grupos Personalizados', breadcrumb: 'CONFIGURAR GRUPOS PERSONALIZADOS' }
    },
    {
        path: 'configurar/grupospersonalizados/lista', component: ListaComponent, data: { title: 'Lista de Grupos Personalizados', breadcrumb: 'CONFIGURAR GRUPOS PERSONALIZADOS' }
    },
    {
        path: 'configurar/cuentacontablepordefecto', component: CuentacontabledefectoComponent, data: { title: 'Cuentas Contables por Defecto', breadcrumb: 'CONFIGURAR CUENTAS CONTABLES' }
    },
    {
        path: 'configurar/cuentabancaria', component: CuentasbancariasComponent, data: { title: 'Cuentas Bancarias', breadcrumb: 'CONFIGURAR CUENTAS BANCARIAS' }
    },
    {
        path: 'configurar/cuentaiva', component: CuentasivaComponent, data: { title: 'Cuentas IVA', breadcrumb: 'CONFIGURAR CUENTAS IVA' }
    },
    {
        path: 'configurar/cuentaimpuesto', component: CuentasimpuestosComponent, data: { title: 'Cuentas Impuestos', breadcrumb: 'CONFIGURAR CUENTAS IMPUESTOS' }
    },
    {
        path: 'configurar/cuentapago', component: CuentaspagosComponent, data: { title: 'Cuentas Pagos', breadcrumb: 'CONFIGURAR CUENTAS PAGOS' }
    },
    {
        path: 'configurar/cuentaproducto', component: CuentasproductosComponent, data: { title: 'Cuentas Productos', breadcrumb: 'CONFIGURAR CUENTAS PRODUCTOS' }
    },
    {
        path: 'configurar/exportacion', component: ExportacionComponent, data: { title: 'Exportación', breadcrumb: 'CONFIGURAR EXPORTACIÓN' }
    },
    {
        path: 'contabilizarcliente/contabilizar', component: ContabilizarCComponent, data: { title: 'Contabilizar Facturas de Cliente', breadcrumb: 'CONTABILIZAR FACTURAS DE CLIENTE' }
    },
    {
        path: 'contabilizarcliente/contabilizada', component: ContabilizadaCComponent, data: { title: 'Facturas Contabilizadas de Cliente', breadcrumb: 'FACTURAS CONTABILIZADAS DE CLIENTE' }
    },
    {
        path: 'contabilizarproveedor/contabilizar', component: ContabilizarPComponent, data: { title: 'Contabilizar Facturas de Proveedor', breadcrumb: 'CONTABILIZAR FACTURAS DE PROVEEDOR' }
    },
    {
        path: 'contabilizarproveedor/contabilizada', component: ContabilizadaPComponent, data: { title: 'Facturas Contabilizadas de Proveedor', breadcrumb: 'FACTURAS CONTABILIZADAS DE PROVEEDOR' }
    },
    {
        path: 'contabilizargasto/contabilizar', component: ContabilizarGComponent, data: { title: 'Contabilizar Facturas de Gasto', breadcrumb: 'CONTABILIZAR FACTURAS DE GASTO' }
    },
    {
        path: 'contabilizargasto/contabilizada', component: ContabilizadaGComponent, data: { title: 'Facturas Contabilizadas de Gasto', breadcrumb: 'FACTURAS CONTABILIZADAS DE GASTO' }
    },
    {
    ...
    {
        path: 'informes/grupopredefinido', component: GpredefinidoComponent, data: { title: 'Informes', breadcrumb: 'PROCESAR INFORMES GRUPO PREDEFINIDO' }
    },
    {
        path: 'informes/grupopersonalizado', component: GpersonalizadoComponent, data: { title: 'Informes', breadcrumb: 'PROCESAR INFORMES GRUPO PERSONALIZADO' }
    },
    {
        path: 'ventas/cliente', component: ClienteComponent, data: { title: 'Volumen de Ventas', breadcrumb: 'PROCESAR VOLUMEN DE VENTAS POR CLIENTE' }
    },
    {
